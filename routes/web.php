...
$router->post('/admin/theme/switch/{theme}', [AdminThemeController::class, 'switch']);
...
$router->post('/admin/themes/preview/{id}', [AdminThemeController::class, 'preview']);
$router->post('/admin/themes/cancel-preview', [AdminThemeController::class, 'cancelPreview']);
