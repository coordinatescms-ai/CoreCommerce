...
class AdminProductController
{
    ...
    private function syncProductAttributes($productId, $attributeRows)
    {
        ...
        foreach ($attributeRows as $row) {
            ...
            $attributeOption = Attribute::getOptionByValue((int) $attributeId, $row['value']);
            if (!$attributeOption) {
                ...
                $optionId = (int) $attributeOption['id'];
            }

            ProductAttribute::setValue((int) $productId, (int) $attributeId, $row['value'], $optionId ?: null);
        }
    }
